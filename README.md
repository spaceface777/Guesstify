...
## Installation
Download the [dist branch](https://github.com/theRealPadster/guesstify/archive/refs/heads/dist.zip) and rename the folder "guesstify". Copy it into the spicetify custom apps folder:
| **Platform**    | **Path**                               |
|-----------------|----------------------------------------|
